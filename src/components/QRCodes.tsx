...
const generateQRPlaceholder = (type: string, color: string) =>
    ...
    <div className="container">
      <div className="section-header">
        ...
        <div className="sns-icons">
          <a href="https://www.instagram.com/yoo.n.yoo.n/" target="_blank" rel="noopener noreferrer" className="sns-link">Instagram</a>
          <a href="https://lin.ee/lyyKSqu" target="_blank" rel="noopener noreferrer" className="sns-link">LINE</a>
        </div>
      ...
      <div className="qr-codes-container">
        <div className="qr-code-card">
          ...
          <div className="qr-code-footer">
            ...
            <a href="https://lin.ee/lyyKSqu" target="_blank" rel="noopener noreferrer" className="btn-primary qr-button">LINEで予約</a>
          </div>
        </div>
        <div className="qr-code-card">
          <div className="qr-code-header">
          ...
          <div className="qr-code-footer">
            ...
            <a href="https://www.instagram.com/yoo.n.yoo.n/" target="_blank" rel="noopener noreferrer" className="btn-secondary qr-button">Instagramを見る</a>
          </div>
        </div>
      </div>
