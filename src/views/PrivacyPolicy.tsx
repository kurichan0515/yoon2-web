        ...
        <div className="container">
          <div className="privacy-content">
            ...
            <div className="privacy-section" ref={addToRefs}>
              <h2>1. 個人情報の収集について</h2>
              <p>当サロンは、以下の場合に個人情報を収集する場合があります：</p>
              <ul>
                <li>LINEでの予約・お問い合わせ時</li>
                <li>電話でのお問い合わせ時</li>
                <li>店舗でのご来店時</li>
              </ul>
              <p>収集する情報には、お名前、連絡先（電話番号、メールアドレス）、ご予約内容などが含まれます。</p>
            </div>
            ...
            <div className="privacy-section" ref={addToRefs}>
              ...
              <p>お客様は、ブラウザの設定によりクッキーの受け入れを拒否することができますが、その場合、一部の機能が正常に動作しない場合があります。</p>
            </div>
            ...
            <div className="privacy-section" ref={addToRefs}>
              ...
              <p>
                お客様ご本人から、個人情報の開示、訂正、削除のご請求があった場合、ご本人確認の上、速やかに対応いたします。
              </p>
              <p>お問い合わせは、LINEまたは電話にてお願いいたします。</p>
            </div>
